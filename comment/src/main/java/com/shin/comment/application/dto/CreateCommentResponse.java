...
@Schema(name = "CreateCommentResponse", description = "Comment data returned after creation")
public record CreateCommentResponse(
        @Schema(description = "Comment id", example = "c5bcf4bf-0e01-4fc8-8706-6b07c2d5e6ea")
        String id,
        @Schema(description = "Thread id. For top-level comments, this value matches id.", example = "c5bcf4bf-0e01-4fc8-8706-6b07c2d5e6ea")
        String threadId,
        @Schema(description = "Parent comment id when this comment is a reply", nullable = true, example = "34dddacf-f148-4eea-bf56-a180fe8f77fe")
        String parentId,
        ...
        String authorUrl,
        @Schema(description = "Sanitized plain content", example = "Great video!")
        String textOriginal,
        @Schema(description = "Formatted display content (HTML-safe)", example = "Great video!")
        String textDisplay,
        @Schema(description = "Current like count", example = "0")
        Long likeCount
) {
}
