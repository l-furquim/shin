...
public abstract class BaseExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBaseException(BaseException ex, HttpServletRequest request) {
        ...
        ProblemDetail problemDetail = createProblemDetail(
            status, ex.getErrorCode(), formatTitle(ex.getErrorCode()),
    ...
    public ResponseEntity<ProblemDetail> handleValidationException(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        log.warn("Validation failed [correlationId={}]: {} errors", correlationId, ex.getBindingResult().getErrorCount());

        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.BAD_REQUEST, ErrorCodes.VALIDATION_FAILED, "Validation Failed",
    ...
    public ResponseEntity<ProblemDetail> handleConstraintViolationException(ConstraintViolationException ex, HttpServletRequest request) {
        ...
        log.warn("Constraint violation [correlationId={}]: {} violations", correlationId, ex.getConstraintViolations().size());
        ...
        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.BAD_REQUEST, ErrorCodes.CONSTRAINT_VIOLATION, "Constraint Violation",
    ...
    public ResponseEntity<ProblemDetail> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpServletRequest request) {
        ...
        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.BAD_REQUEST, ErrorCodes.VALIDATION_FAILED, "Malformed Request",
    ...
    public ResponseEntity<ProblemDetail> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, HttpServletRequest request) {
        String correlationId = getCorrelationId();
    ...
    public ResponseEntity<ProblemDetail> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        String correlationId = getCorrelationId();
    ...
    public ResponseEntity<ProblemDetail> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
        ...
        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.BAD_REQUEST, ErrorCodes.VALIDATION_FAILED, "Invalid Parameter Type",
            message, request.getRequestURI(), correlationId
        );
    ...
    public ResponseEntity<ProblemDetail> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpServletRequest request) {
        ...
        log.warn("No handler found [correlationId={}]: {} {}", correlationId, ex.getHttpMethod(), ex.getRequestURL());

        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.NOT_FOUND, "ENDPOINT_NOT_FOUND", "Endpoint Not Found",
    ...
    public ResponseEntity<ProblemDetail> handleDataIntegrityViolation(DataIntegrityViolationException ex, HttpServletRequest request) {
        ...
        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.CONFLICT, ErrorCodes.DATABASE_ERROR, "Data Integrity Violation",
            extractUserFriendlyDatabaseMessage(ex),
            request.getRequestURI(), correlationId
        );
    ...
    public ResponseEntity<ProblemDetail> handleOptimisticLockingFailure(OptimisticLockingFailureException ex, HttpServletRequest request) {
        ...
        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.CONFLICT, ErrorCodes.CONCURRENT_MODIFICATION, "Concurrent Modification",
    ...
    public ResponseEntity<ProblemDetail> handleGenericException(Exception ex, HttpServletRequest request) {
        ...
        ProblemDetail problemDetail = createProblemDetail(
            HttpStatus.INTERNAL_SERVER_ERROR, ErrorCodes.INTERNAL_SERVER_ERROR, "Internal Server Error",
    ...
    protected ProblemDetail createProblemDetail(HttpStatus status, String errorCode, String title, String detail, String instance, String correlationId) {
    ...
    protected void addValidationErrors(ProblemDetail problemDetail, List<FieldError> fieldErrors) {
    ...
    protected void addConstraintViolations(ProblemDetail problemDetail, Map<String, String> violations) {
    ...
    protected HttpStatus determineHttpStatus(BaseException ex) {
        try {
    ...
    protected String formatTitle(String errorCode) {
    ...
    protected String extractUserFriendlyDatabaseMessage(DataIntegrityViolationException ex) {
